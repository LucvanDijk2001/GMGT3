function scr_GUI_draw_text_color_dialogue(xpos,ypos,_string,_scale,c1,c2,c3,c4,alpha = 1, viewport = 0){
	...
	draw_text_transformed_color(pos_x,pos_y,_string,scale_x*_scale,scale_y*_scale,0,c1,c2,c3,c4,alpha);
}