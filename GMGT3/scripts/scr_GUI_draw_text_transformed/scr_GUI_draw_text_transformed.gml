//draw some text on gui in worldspace scaled
function scr_GUI_draw_text_transformed(xpos,ypos,_string,xscale,yscale,viewport = 0){
	var pos_x;
	var pos_y;
	...
	draw_text_transformed(pos_x,pos_y,_string,scale_x*xscale,scale_y*yscale,0)
}