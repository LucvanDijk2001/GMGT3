...
global.SpocPack_textbox_height = 64;  //height of textbox
global.SpocPack_textbox_y      = 96;  //textbox position y
global.SpocPack_textbox_x      = 0;   //textbox position x (doesn't really get used cause of the offsets)
...
global.SpocPack_textbox_middle_x_pos         = 56;  //x offset for textbox no portrait
global.SpocPack_textbox_left_x_pos           = 16;  //x offset for textbox on left
...
//text
global.SpocPack_dialogue_text_scale = .5; //text scale
